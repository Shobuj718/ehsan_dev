        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <span class="info-box-number"><?//= $six; ?>111</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $seven; ?>222</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $eight; ?>133</span>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $nine; ?>144</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $ten; ?>222</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $vocational; ?>88</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $attendStudent; ?>333</span>
            </div>
        ...
        <div class="col-md-3 col-sm-6 col-xs-12">
          <div class="info-box">
            ...
            <div class="info-box-content">
              ...
              <p>Today: <?php echo date('d-m-y') ?></p>
              <span class="info-box-number"><?//= $attendTeacher; ?>21</span>
            </div>
            <!-- /.info-box-content -->
          </div>
          <!-- /.info-box -->
