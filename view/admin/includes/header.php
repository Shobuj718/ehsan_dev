      ...
      <div class="navbar-custom-menu">
        <ul class="nav navbar-nav">
          ...
          <li class="dropdown user user-menu">
            <a href="#" class="dropdown-toggle" data-toggle="dropdown">
              <img src="view/admin/uploads/user/shobuj.jpg" class="user-image" alt="User Image">
              <span class="hidden-xs">Shobuj Islam</span>
            </a>
            <ul class="dropdown-menu">
              <!-- User image -->
                ...
                <li class="treeview">
                        ...
                        ?>
                          ...
                          <li><a href="view/admin/scanner/index.php"><i class="fa fa-circle-o"></i> আইডি কার্ড পাঞ্চ </a></li>
                            ...
                            -->
                              ...
                              <li><a href="javascript:void(0)"><i class="fa fa-circle-o"></i> আইডি কার্ড পাঞ্চ </a></li>
                            <li><a href="javascript:void(0)"><i class="fa fa-circle-o"></i> এস এম এস সংখ্যা </a></li>
                  ...
                  <i class="fa fa-angle-left pull-right"></i>
                        ...
                        <ul class="treeview-menu">
                            ...
                            <li><a href="view/admin/scannerTea/leave.php"><i class="fa fa-circle-o"></i> শিক্ষকদের ছুটি প্রদান  </a></li>
                            <li><a href="view/admin/scannerTea/leaveSchool.php"><i class="fa fa-circle-o"></i> শিক্ষকদের চলে যাওয়া   </a></li>
                            <li><a href="javascript:void(0)"><i class="fa fa-circle-o"></i> ফিঙ্গার প্রিন্ট </a></li>
                            <li><a href="javascript:void(0)"><i class="fa fa-circle-o"></i> সংশোধন করা </a></li>
